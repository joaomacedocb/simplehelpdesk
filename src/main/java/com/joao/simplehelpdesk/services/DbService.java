...
public class DbService {
	...
	public void instanciaDb() {
		...
		Tecnico tec1 = new Tecnico(null, "Joao", "03029092062", "joao@mail.com", encoder.encode("123455"));
		tec1.addPerfil(Perfil.ADMIN);

		Tecnico tec2 = new Tecnico(null, "Maria", "66587045030", "maria@mail.com", encoder.encode("123455"));
		tec2.addPerfil(Perfil.TECNICO);

		Tecnico tec3 = new Tecnico(null, "Carlos", "84984999098", "carlos@mail.com", encoder.encode("123455"));
		tec3.addPerfil(Perfil.TECNICO);

		Tecnico tec4 = new Tecnico(null, "Ana", "53866904002", "ana@mail.com", encoder.encode("123455"));
		tec4.addPerfil(Perfil.TECNICO);

		Tecnico tec5 = new Tecnico(null, "Lucas", "19595463094", "lucas@mail.com", encoder.encode("123455"));
		tec5.addPerfil(Perfil.TECNICO);
		

		Cliente cli1 = new Cliente(null, "Pedro", "51744627053", "cliente1@mail.com", encoder.encode("123455"));
		Cliente cli2 = new Cliente(null, "Mariana", "60716668050", "cliente2@mail.com", encoder.encode("123455"));
		Cliente cli3 = new Cliente(null, "Roberto", "21940448093", "cliente3@mail.com", encoder.encode("123455"));
		Cliente cli4 = new Cliente(null, "Clara", "86774612059", "cliente4@mail.com", encoder.encode("123455"));
		Cliente cli5 = new Cliente(null, "Felipe", "76737341098", "cliente5@mail.com", encoder.encode("123455"));
		Cliente cli6 = new Cliente(null, "Julia", "77071584079", "cliente6@mail.com", encoder.encode("123455"));
		Cliente cli7 = new Cliente(null, "Renato", "29751602084", "cliente7@mail.com", encoder.encode("123455"));
		Cliente cli8 = new Cliente(null, "Sofia", "98586452017", "cliente8@mail.com", encoder.encode("123455"));
		Cliente cli9 = new Cliente(null, "Vinicius", "84156528014", "cliente9@mail.com", encoder.encode("123455"));
		Cliente cli10 = new Cliente(null, "Larissa", "25404273089", "cliente10@mail.com", encoder.encode("123455"));
		...
		pessoaRepository.saveAll(Arrays.asList(cli1, cli2, cli3, cli4, cli5, cli6, cli7, cli8, cli9, cli10,tec1, tec2, tec3, tec4, tec5));
